...
import com.example.chillchat.databinding.ItemContainerRecentConversationBinding;
import com.example.chillchat.listeners.ConversionListener;
import com.example.chillchat.models.ChatMessage;
import com.example.chillchat.models.users; // Corrected import for the user model
    ...
    class ConversationViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage) {
            ...
            binding.getRoot().setOnClickListener(v -> {
                // Create a new user object and populate it with conversation details
                users user = new users(); // Use the correct `users` model
